...
public class AnnotationTest {
    ...
    public void test010() throws Exception {
        ...
        MyAnnotation myAnnotation = showMethod.getAnnotation(MyAnnotation.class);
        System.out.println("val:"+myAnnotation.val()+"----str:"+myAnnotation.str());

        Method displayMethod = Person.class.getMethod("display",String.class);
        myAnnotation = displayMethod.getAnnotation(MyAnnotation.class);
        System.out.println("val:"+myAnnotation.val()+"----str:"+myAnnotation.str());

        Annotation[] annotations = displayMethod.getAnnotations();
        for (Annotation a :
                annotations) {
            System.out.println(a.annotationType().equals(MyAnnotation.class));
